...
[![Test Results](https://img.shields.io/badge/test--results-HTML-9b59b6)](https://peviitor-scrapers.github.io/artsoft-consult-srl-nodejs-scraper/test-results/)
...
[![GitHub Pages](https://img.shields.io/github/deployments/sebiboga/artsoft-consult-srl-nodejs-scraper/github-pages?label=GitHub%20Pages)](https://peviitor-scrapers.github.io/artsoft-consult-srl-nodejs-scraper/)

# job_seeker_ro_spider — ArtSoft Consult Scraper

**job_seeker_ro_spider** — un scraper pentru job-urile ArtSoft Consult din România. Extrage anunțurile de pe [ArtSoft Consult careers](https://www.artsoft-consult.ro/careers/job-openings) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul Peviitor.
