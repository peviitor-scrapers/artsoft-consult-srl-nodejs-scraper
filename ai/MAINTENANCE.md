...
```bash
gh issue list --repo sebiboga/artsoft-consult-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "ArtSoft Consult", not a different company
