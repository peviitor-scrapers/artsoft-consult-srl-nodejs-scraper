...
| group        | string   | Parent company group (e.g. "ARTSOFT CONSULT SRL") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/sebiboga/artsoft-consult-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)