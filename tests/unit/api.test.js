...
describe('scraper/api.js', () => {
  ...
  describe('querySOLR', () => {
    it('should return response object with docs', async () => {
      mockFetch.mockResolvedValue(makeJsonResponse({
        total: 2,
        data: [
          { id: 'job1', url: 'https://test.com/1', cif: '15997630' },
          { id: 'job2', url: 'https://test.com/2', cif: '15997630' }
        ]
      }));
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.querySOLR('15997630')).rejects.toThrow('API jobs query error: 500');
    });
  });
  ...
  describe('deleteJobsByCIF', () => {
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.deleteJobsByCIF('15997630')).rejects.toThrow('API jobs delete error: 500');
    });
  });
